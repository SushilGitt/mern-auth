...
const EmailVerify = () => {
    ...
    const {backendUrl, isLogged, userData, getUserData, loading} = useContext(AppContext)
    ...
    const handleSubmit = async (e) => {
        try {
            ...
            const res = await fetch(`${backendUrl}/api/users/verify-email`, {
                method: "POST",
    ...
    useEffect(() => {
        !isLogged && !userData && !userData.isAccountVerified && navigate("/", {replace: true})
