...
const ResetPassword = () => {
    ...
    const { backendUrl, isLogged, loading } = useContext(AppContext)
    ...
    const onSubmitEmail = async (e) => {
        try {
            e.preventDefault()
            const res = await fetch(`${backendUrl}/api/users/send-pass-reset-otp`, {
                method: "POST",
    ...
    const onSubmitNewPassword = async (e) => {
        try {
            e.preventDefault()
            const res = await fetch(`${backendUrl}/api/users/pass-reset`, {
                method: "POST",
                headers: { "Content-Type": "application/json" },
